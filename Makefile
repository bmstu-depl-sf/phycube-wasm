...
# Период зарождения новых частиц
BORN_PERIOD=250
# Параметры каждой частицы: энергия, масса, заряд, название
PARTICLE_SPECS={{1e-17, 9.1e-31, -1.6e-19, "Электроны"}, {1e-17, 9.1e-31, +1.6e-19, "Позитроны"}, {1e-15, 1.7e-27, +1.6e-19, "Протоны"}, {1e-15, 1.7e-27, +0, "Нейтроны"}, {1e-15, 6.6e-27, +3.2e-19, "Альфа-частицы"}}
